...
def api_cell_dashboard():
    ...
    try:
        ...
        # round float fields
        for r in rows:
            if r.get("Cell_Capacity_Actual") is not None:
                r["Cell_Capacity_Actual"] = round(float(r["Cell_Capacity_Actual"]), 3)
        ...
        if station_table == "ACIR_Testing_Station":
            ...
            for row in rows:
                transformed_rows.append({
                    ...
                    "ModuleBarcode": row["ModuleBarcode"],
            ...
            columns = [
                "DateTime", "Shift", "Operator", "ModuleBarcode",
